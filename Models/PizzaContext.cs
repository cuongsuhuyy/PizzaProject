    ...
    public class PizzaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Pizza>().HasData(
                new Pizza { ID = 1, PizzaID = RandomString(), PizzaName = "Pizza Pho Mai", Price = 100000 },
                new Pizza { ID = 2, PizzaID = RandomString(), PizzaName = "Pizza Xuc Xich", Price = 100000 },
                new Pizza { ID = 3, PizzaID = RandomString(), PizzaName = "Pizza Bo", Price = 100000 },
                new Pizza { ID = 4, PizzaID = RandomString(), PizzaName = "Pizza Mi Y", Price = 100000 },
                new Pizza { ID = 5, PizzaID = RandomString(), PizzaName = "Pizza Rau Cu", Price = 100000 },
                new Pizza { ID = 6, PizzaID = RandomString(), PizzaName = "Pizza Heo", Price = 100000 },
                new Pizza { ID = 7, PizzaID = RandomString(), PizzaName = "Pizza Pho Mai Tuoi", Price = 100000 },
                new Pizza { ID = 8, PizzaID = RandomString(), PizzaName = "Pizza Heo Quay", Price = 100000 },
                new Pizza { ID = 9, PizzaID = RandomString(), PizzaName = "Pizza Thit Ba Chi", Price = 100000 },
                new Pizza { ID = 10, PizzaID = RandomString(), PizzaName = "Pizza Ca Chua", Price = 100000 },
                new Pizza { ID = 11, PizzaID = RandomString(), PizzaName = "Pizza Sau Rieng", Price = 100000 }
                );
